...
const cheers_c2 = `
 ...
 _____                             _   _              _
|  _  |                           | | (_)            | |
| | | |_   _  __ _ _ __ __ _ _ __ | |_ _ _ __   ___  | |
| | | | | | |/ _`+"`"+` | '__/ _`+"`"+` | '_ \| __| | '_ \ / _ \ | |
\ \/' / |_| | (_| | | | (_| | | | | |_| | | | |  __/ |_|
 \_/\_\\__,_|\__,_|_|  \__,_|_| |_|\__|_|_| |_|\___| (_)
...
.:'::.                                                .::':.
 ':. ':::::.___.____,__________________ _._____..:::::' ,'
   ':.    ':::::::::::::::::::::::::::::::::::::'     : '
     ':.                                            .:'
       ':.      https://github.com/Jonatandb       .:'
         '.                                      .'
           '-._      jonatandb@gmail.com     _.-'
               '- .._                 _.. -'
                     ''' - .,.,. - '''
                          (:' .:)
                           :| '|
...
func NewTitle() *Title {
	...
	t.AddCostume(sprite.NewCostume(cheers_c2, 'x'))
...
func main() {
	...
	txt1 := "Press 'ESC' to quit."
	c1 := sprite.NewCostume(txt1, '~')
	text := sprite.NewBaseSprite(Width/2-len(txt1)/2, Height-3, c1)
